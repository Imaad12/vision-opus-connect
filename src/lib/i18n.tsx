...
export const dict: Dict = {
  ...
  "imp.upload.hint": {
    en: "Select one or many files. Start with 100–500 documents to check extraction quality before scaling up.",
    ar: "اختر ملفاً واحداً أو عدة ملفات. ابدأ بـ 100–500 مستند للتحقق من جودة الاستخراج قبل التوسع.",
  },
