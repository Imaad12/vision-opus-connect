...
export const dict: Dict = {
  ...
  "users.claim.title": { en: "Set up your VINCO login", ar: "إعداد دخولك إلى VINCO" },
  "users.claim.description": {
    en: "This account doesn't have a native VINCO username yet. Choose one now to set your own password and use it to sign in from then on.",
    ar: "لا يملك هذا الحساب اسم مستخدم VINCO بعد. اختر واحداً الآن لتعيين كلمة المرور الخاصة بك واستخدامها لتسجيل الدخول لاحقاً.",
  },
  "users.claim.submit": { en: "Set up my login", ar: "إعداد دخولي" },
  "users.claim.submitting": { en: "Setting up…", ar: "جارٍ الإعداد…" },
  "users.claim.success_note": {
    en: "Your VINCO login is ready. You're still signed in for now — next time, sign in with this username and the temporary password below, then set your own.",
    ar: "دخولك إلى VINCO جاهز. أنت لا تزال مسجلاً الدخول حالياً — في المرة القادمة، سجّل الدخول باستخدام اسم المستخدم هذا وكلمة المرور المؤقتة أدناه، ثم عيّن كلمة مرورك الخاصة.",
  },
  ...
  "nav.client_po": { en: "POs Awarded by Client", ar: "أوامر الشراء الصادرة من العميل" },
  ...
  "settings.company_name": { en: "Company name", ar: "اسم الشركة" },
  "settings.company_name_ar": { en: "Company name (Arabic)", ar: "اسم الشركة (عربي)" },
  "settings.cr_number": { en: "CR number", ar: "رقم السجل التجاري" },
  "settings.vat_number": { en: "VAT number", ar: "الرقم الضريبي" },
  "settings.currency": { en: "Currency", ar: "العملة" },
  "settings.vat_rate": { en: "Standard VAT rate (%)", ar: "نسبة ضريبة القيمة المضافة (%)" },
  "settings.vat_rate_invalid": {
    en: "VAT rate must be between 0 and 100.",
    ar: "يجب أن تكون نسبة الضريبة بين 0 و 100.",
  },
  ...
  "settings.system_info_title": {
    en: "Numbering & approval conventions",
    ar: "اصطلاحات الترقيم والاعتماد",
  },
  "settings.system_info_description": {
    en: "Not enforced by any system function or database trigger today — these are naming conventions only. Reference numbers are entered manually and simply must be unique; an imported historical document's original reference is never reformatted to match this pattern.",
    ar: "لا يتم فرضها بواسطة أي دالة نظام أو محفز قاعدة بيانات حالياً — هذه اصطلاحات تسمية فقط. تُدخل الأرقام المرجعية يدوياً ويجب أن تكون فريدة فقط؛ لا تتم إعادة صياغة الرقم المرجعي الأصلي للمستند التاريخي المستورد ليطابق هذا النمط.",
  },
  "settings.quotation_numbering": {
    en: "Quotation numbering convention",
    ar: "اصطلاح ترقيم عروض الأسعار",
  },
  "settings.po_numbering": {
    en: "Purchase order numbering convention",
    ar: "اصطلاح ترقيم أوامر الشراء",
  },
  "settings.invoice_numbering": { en: "Invoice numbering convention", ar: "اصطلاح ترقيم الفواتير" },
  "settings.approval_rule": { en: "Quotation approval", ar: "اعتماد عروض الأسعار" },
  "settings.approval_rule_value": {
    en: "Gated by the quotations.approve permission (application-enforced, not a database trigger)",
    ar: "مقيّد بصلاحية quotations.approve (مُطبّق على مستوى التطبيق، وليس محفز قاعدة بيانات)",
  },
  ...
  "quote.import_historical": { en: "Import Historical Quotations", ar: "استيراد عروض أسعار سابقة" },

  "imp.title": { en: "Import Historical Quotations", ar: "استيراد عروض أسعار سابقة" },
  "imp.description": {
    en: "Upload scanned/digital quotation documents into a batch, then review and confirm each one before it becomes a real record. Nothing is created automatically from OCR alone.",
    ar: "ارفع مستندات عروض الأسعار الممسوحة ضوئياً أو الرقمية ضمن دفعة، ثم راجع وأكّد كل واحد منها قبل أن يصبح سجلاً حقيقياً. لا يتم إنشاء أي شيء تلقائياً من التعرف الضوئي وحده.",
  },
  "imp.batch.title": { en: "Batch", ar: "الدفعة" },
  "imp.batch.select": { en: "Select a batch…", ar: "اختر دفعة…" },
  "imp.batch.new_label": { en: "New batch label (optional)", ar: "اسم دفعة جديدة (اختياري)" },
  "imp.batch.create": { en: "Create batch", ar: "إنشاء دفعة" },
  "imp.batch.rename": { en: "Rename", ar: "إعادة تسمية" },
  "imp.batch.delete": { en: "Delete batch", ar: "حذف الدفعة" },
  "imp.batch.archive": { en: "Archive", ar: "أرشفة" },
  "imp.batch.cancel_processing": { en: "Cancel", ar: "إلغاء" },
  "imp.batch.edit_title": { en: "Edit batch", ar: "تعديل الدفعة" },
  "imp.batch.label_field": { en: "Label", ar: "الاسم" },
  "imp.batch.notes_field": { en: "Notes (optional)", ar: "ملاحظات (اختياري)" },
  "imp.batch.confirm_delete": {
    en: "Delete this batch and every document staged under it? This cannot be undone.",
    ar: "هل تريد حذف هذه الدفعة وكل المستندات المرحّلة ضمنها؟ لا يمكن التراجع عن هذا الإجراء.",
  },
  "imp.batch.confirm_cancel": {
    en: "Cancel processing for every queued document in this batch? Documents already being processed will still finish.",
    ar: "إلغاء معالجة كل المستندات المنتظرة في هذه الدفعة؟ المستندات قيد المعالجة حالياً ستكتمل رغم ذلك.",
  },
  "imp.batch.status.EMPTY": { en: "Empty", ar: "فارغة" },
  "imp.batch.status.STAGING": { en: "Staging", ar: "قيد التجهيز" },
  "imp.batch.status.PROCESSING": { en: "Processing", ar: "قيد المعالجة" },
  "imp.batch.status.COMPLETED": { en: "Completed", ar: "مكتملة" },
  "imp.batch.status.ARCHIVED": { en: "Archived", ar: "مؤرشفة" },
  "imp.batch.archived_readonly": {
    en: "This batch is archived and read-only.",
    ar: "هذه الدفعة مؤرشفة وللقراءة فقط.",
  },
  "imp.upload.title": { en: "Upload documents", ar: "رفع المستندات" },
  "imp.upload.button": { en: "Upload", ar: "رفع" },
  "imp.upload.choose_files": { en: "Choose files", ar: "اختر الملفات" },
  "imp.upload.hint": {
    en: "Select one or many PDF files. Start with 100–500 documents to check extraction quality before scaling up.",
    ar: "اختر ملف PDF واحداً أو عدة ملفات. ابدأ بـ 100–500 مستند للتحقق من جودة الاستخراج قبل التوسع.",
  },
  "imp.upload.selected_suffix": { en: "file(s) selected", ar: "ملف(ات) محددة" },
  "imp.upload.accepted_suffix": {
    en: "file(s) received — processing started",
    ar: "ملف(ات) تم استلامها — بدأت المعالجة",
  },
  "imp.status.pending": { en: "Uploading…", ar: "جارٍ الرفع…" },
  "imp.status.extracting": { en: "Extracting…", ar: "جارٍ الاستخراج…" },
  "imp.status.complete": { en: "Ready for review", ar: "جاهز للمراجعة" },
  "imp.status.ocr_required": {
    en: "OCR required — not available",
    ar: "يتطلب تعرفاً ضوئياً — غير متاح",
  },
  "imp.status.segments_proposed": { en: "Segments proposed", ar: "تم اقتراح مقاطع" },
  "imp.status.multiple_quotations": {
    en: "Multiple quotations detected",
    ar: "تم اكتشاف عروض أسعار متعددة",
  },
  "imp.status.unsupported": { en: "Unsupported file", ar: "ملف غير مدعوم" },
  "imp.status.failed": { en: "Failed", ar: "فشل" },
  "imp.status.queued": { en: "Queued", ar: "في الانتظار" },
  "imp.status.processing": { en: "Processing", ar: "قيد المعالجة" },
  "imp.summary.total": { en: "Total", ar: "الإجمالي" },
  "imp.summary.queued": { en: "Queued", ar: "في الانتظار" },
  "imp.summary.processing": { en: "Processing", ar: "قيد المعالجة" },
  "imp.summary.needs_review": { en: "Needs review", ar: "بحاجة لمراجعة" },
  "imp.summary.confirmed": { en: "Confirmed", ar: "مؤكد" },
  "imp.summary.rejected": { en: "Rejected", ar: "مرفوض" },
  "imp.summary.failed": { en: "Failed", ar: "فشل" },
  "imp.summary.duplicates": { en: "Duplicates", ar: "مكرر" },
  "imp.table.filename": { en: "File", ar: "الملف" },
  "imp.table.size": { en: "Size", ar: "الحجم" },
  "imp.table.extraction": { en: "Extraction", ar: "الاستخراج" },
  "imp.table.review": { en: "Review status", ar: "حالة المراجعة" },
  "imp.table.attempts": { en: "Attempts", ar: "المحاولات" },
  "imp.action.review": { en: "Review", ar: "مراجعة" },
  "imp.action.retry": { en: "Retry", ar: "إعادة المحاولة" },
  "imp.action.view": { en: "View", ar: "عرض" },
  "imp.action.retried_note": {
    en: "Re-queued for another attempt.",
    ar: "تمت إعادة الجدولة لمحاولة أخرى.",
  },
  "imp.review.title": { en: "Review extracted quotation", ar: "مراجعة عرض السعر المستخرج" },
  "imp.review.source_note": {
    en: "Extracted automatically — verify against the source document before confirming. Nothing below is financial truth until you confirm it.",
    ar: "تم الاستخراج تلقائياً — تحقق من المستند المصدر قبل التأكيد. لا شيء أدناه يُعد حقيقة مالية حتى تؤكده.",
  },
  "imp.review.no_candidate": {
    en: "No extracted fields yet — extraction may have failed or is still pending.",
    ar: "لا توجد حقول مستخرجة بعد — قد يكون الاستخراج قد فشل أو ما زال معلقاً.",
  },
  "imp.review.client_name": { en: "Client (new or existing)", ar: "العميل (جديد أو موجود)" },
  "imp.review.project_name": { en: "Project (new or existing)", ar: "المشروع (جديد أو موجود)" },
  "imp.review.include_boq": { en: "Include BOQ lines", ar: "تضمين بنود جدول الكميات" },
  "imp.review.confirm": { en: "Confirm & Create", ar: "تأكيد وإنشاء" },
  "imp.review.reject": { en: "Reject", ar: "رفض" },
  "imp.review.reject_reason": { en: "Reason (optional)", ar: "السبب (اختياري)" },
  "imp.review.confirmed_note": {
    en: "Confirmed — a real client, project, and quotation now exist for this document.",
    ar: "تم التأكيد — يوجد الآن عميل ومشروع وعرض سعر حقيقي لهذا المستند.",
  },
  "imp.review.rejected_note": {
    en: "Rejected. No business record was created.",
    ar: "تم الرفض. لم يتم إنشاء أي سجل.",
  },
  "imp.review.field.quotation_number": { en: "Reference / Quotation #", ar: "الرقم المرجعي" },
  "imp.review.field.quotation_date": { en: "Date", ar: "التاريخ" },
  "imp.review.field.currency": { en: "Currency", ar: "العملة" },
  "imp.review.field.net_value": { en: "Subtotal (net)", ar: "الإجمالي قبل الضريبة" },
  "imp.review.field.tax_value": { en: "VAT", ar: "ضريبة القيمة المضافة" },
  "imp.review.field.gross_value": { en: "Total (incl. VAT)", ar: "الإجمالي شامل الضريبة" },
  "imp.review.field.valid_until": { en: "Valid until", ar: "صالح حتى" },
  "imp.review.field.project_number": { en: "Project #", ar: "رقم المشروع" },
  "imp.review.field.payment_terms": { en: "Payment terms", ar: "شروط الدفع" },
  "imp.review.field.description": { en: "Description", ar: "الوصف" },
  "imp.review.notes": { en: "Notes", ar: "ملاحظات" },
  "imp.review.more_fields": { en: "More details", ar: "تفاصيل إضافية" },
  "imp.review.save_changes": { en: "Save changes", ar: "حفظ التغييرات" },
  "imp.review.saved_note": { en: "Corrections saved.", ar: "تم حفظ التصحيحات." },
  "imp.review.preview.unavailable": {
    en: "No page preview is available for this file type.",
    ar: "لا تتوفر معاينة للصفحات لهذا النوع من الملفات.",
  },
  "imp.review.preview.load_error": {
    en: "Could not load this page.",
    ar: "تعذر تحميل هذه الصفحة.",
  },
  "imp.review.preview.page": { en: "Page", ar: "صفحة" },
  "imp.review.preview.of": { en: "of", ar: "من" },
  ...
  "client_po.description": {
    en: "Client purchase orders recorded as evidence a quotation was awarded — independent of the quoted value, with variance shown where it differs.",
    ar: "أوامر الشراء الصادرة من العملاء المسجّلة كدليل على إرساء عرض السعر — مستقلة عن القيمة المعروضة، مع إظهار الفرق عند اختلافها.",
  },
  "client_po.po_number": { en: "Client PO Number", ar: "رقم أمر الشراء" },
  "client_po.po_date": { en: "PO Date", ar: "تاريخ أمر الشراء" },
  "client_po.quotation_ref": { en: "Quotation Reference", ar: "الرقم المرجعي لعرض السعر" },
  "client_po.awarded_value": { en: "Awarded Value", ar: "القيمة المرساة" },
  "client_po.vat": { en: "VAT", ar: "ضريبة القيمة المضافة" },
  "client_po.total_value": { en: "Total Value", ar: "القيمة الإجمالية" },
  "client_po.source": { en: "Source", ar: "المصدر" },
  "client_po.source.manual": { en: "Manual", ar: "يدوي" },
  "client_po.source.imported": { en: "Imported (OCR)", ar: "مستورد (تعرف ضوئي)" },
  "client_po.document": { en: "Document", ar: "المستند" },
  "client_po.record_action": { en: "Record Client PO", ar: "تسجيل أمر الشراء" },
  "client_po.dialog_title": { en: "Record client PO", ar: "تسجيل أمر شراء العميل" },
  "client_po.quoted_value": { en: "Quoted value (reference)", ar: "القيمة المعروضة (مرجعية)" },
  "client_po.variance": { en: "Variance vs. quoted value", ar: "الفرق عن القيمة المعروضة" },
  "client_po.upload_document": {
    en: "Attach PO document (optional)",
    ar: "إرفاق مستند أمر الشراء (اختياري)",
  },
  "client_po.no_document": { en: "No document attached.", ar: "لا يوجد مستند مرفق." },
  "client_po.create_contract": { en: "Create contract", ar: "إنشاء عقد" },
  "client_po.status.not_recorded": { en: "Not recorded", ar: "غير مسجّل" },
