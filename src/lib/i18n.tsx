...
export const dict: Dict = {
  ...
  "settings.system_info_title": { en: "System-enforced settings", ar: "إعدادات يفرضها النظام" },
  "settings.system_info_description": {
    en: "Not currently editable here — document numbering is generated by a database function and separation-of-duties is enforced by database triggers.",
    ar: "غير قابلة للتعديل هنا حالياً — يتم إنشاء ترقيم المستندات بواسطة دالة قاعدة بيانات، ويتم فرض فصل المهام بواسطة محفزات قاعدة البيانات.",
  },
  "settings.quotation_numbering": { en: "Quotation numbering", ar: "ترقيم عروض الأسعار" },
  "settings.po_numbering": { en: "Purchase order numbering", ar: "ترقيم أوامر الشراء" },
  "settings.invoice_numbering": { en: "Invoice numbering", ar: "ترقيم الفواتير" },
  "settings.approval_rule": { en: "Approval rule", ar: "قاعدة الاعتماد" },
  "settings.approval_rule_value": {
    en: "Separation of duties enforced in the database",
    ar: "فصل المهام مُطبّق في قاعدة البيانات",
  },
